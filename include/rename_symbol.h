...
#define ttm_bo_swapout amdttm_bo_swapout //ttm/ttm_bo.c:EXPORT_SYMBOL(ttm_bo_swapout);
...
#define ttm_check_under_lowerlimit amdttm_check_under_lowerlimit //ttm/ttm_memory.c:EXPORT_SYMBOL(ttm_check_under_lowerlimit);
...
#define drm_sched_dependency_optimized amddrm_sched_dependency_optimized //scheduler/gpu_scheduler.c:EXPORT_SYMBOL(drm_sched_dependency_optimized);
#define drm_sched_entity_fini amddrm_sched_entity_fini //scheduler/gpu_scheduler.c:EXPORT_SYMBOL(drm_sched_entity_fini);
#define drm_sched_entity_init amddrm_sched_entity_init //scheduler/gpu_scheduler.c:EXPORT_SYMBOL(drm_sched_entity_init);
#define drm_sched_entity_push_job amddrm_sched_entity_push_job //scheduler/gpu_scheduler.c:EXPORT_SYMBOL(drm_sched_entity_push_job);
#define drm_sched_entity_set_rq amddrm_sched_entity_set_rq //scheduler/gpu_scheduler.c:EXPORT_SYMBOL(drm_sched_entity_set_rq);
#define drm_sched_fini amddrm_sched_fini //scheduler/gpu_scheduler.c:EXPORT_SYMBOL(drm_sched_fini);
#define drm_sched_hw_job_reset amddrm_sched_hw_job_reset //scheduler/gpu_scheduler.c:EXPORT_SYMBOL(drm_sched_hw_job_reset);
#define drm_sched_init amddrm_sched_init //scheduler/gpu_scheduler.c:EXPORT_SYMBOL(drm_sched_init);
#define drm_sched_job_init amddrm_sched_job_init //scheduler/gpu_scheduler.c:EXPORT_SYMBOL(drm_sched_job_init);
#define drm_sched_job_recovery amddrm_sched_job_recovery //scheduler/gpu_scheduler.c:EXPORT_SYMBOL(drm_sched_job_recovery);
#define to_drm_sched_fence amdto_drm_sched_fence //scheduler/sched_fence.c:EXPORT_SYMBOL(to_drm_sched_fence);
